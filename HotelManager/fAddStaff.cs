        ...
        private void InsertStaff()
        {
            ...
            if (isFill)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Thêm Thành Công\n Mật khẩu mặc định cho tài khoản " + txbName.Text +
                            ": 12345678", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                        MessageBox.Show("Nhân Viên Đã Tồn Tại(Trùng tên đăng nhập hoặc Số CMND/CCCD)", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
                catch
                {
