...
namespace HotelManager
{
    ...
    {
        #region Properties
        public static readonly string HassPass = "25d55ad283aa400af464c76d713c07ad"; // password default
        #endregion
        ...
        private void ResetPassword()
        {
            try
            {
                ...
                if (check)
                {
                    MessageBox.Show( "Đặt lại mật khẩu thành công\nMật khẩu mặt định là: 12345678", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
        ...
        private void TxbSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)
                ...
                if (e.KeyChar == 27 && btnClose1.Visible == true)
