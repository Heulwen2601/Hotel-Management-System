...
namespace HotelManager.DTO
{
    public class Room
    {
        ...
        public Room() { }
        public Room(int id, string name, int idRoomType,int idStatusRoom, string idCardCustomer)
        {
            this.Id = id;
            this.Name = name;
        ...
        public Room(DataRow row)
        {
            ...
            //this.IdCardCustomer = (int)row["idCardCustomer"];
        }
        public bool Equals(Room roomPre)
        {
            ...
            if (roomPre.idCardCustomer != this.idCardCustomer) return false;
            return true;
        }
