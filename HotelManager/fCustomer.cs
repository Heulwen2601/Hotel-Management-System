    ...
    public partial class fCustomer : Form
    {
        ...
        private void ChangeText(DataGridViewRow row)
        {
            ...
            else
            {
                ...
                comboboxID.SelectedItem = row.Cells["colID"].Value;
                txbFullName.Text = row.Cells["colName"].Value.ToString();
        ...
        {
            // TODO: This line of code loads data into the 'hotelManagementDataSet.CUSTOMER' table. You can move, or remove it, as needed.
